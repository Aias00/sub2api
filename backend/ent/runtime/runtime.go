...
import (
	...
	"github.com/Aias00/cloudbase/ent/schema"
	...
	"github.com/Aias00/cloudbase/ent/usagecleanuptask"
...
func init() {
	...
	channelmonitorDescAutoDisabled := channelmonitorFields[9].Descriptor()
	...
	channelmonitorDescAutoDisabledReason := channelmonitorFields[11].Descriptor()
	...
	channelmonitorDescLastHealthStatus := channelmonitorFields[13].Descriptor()
	...
	// subscriptionplanDescCreemProductID is the schema descriptor for creem_product_id field.
	subscriptionplanDescCreemProductID := subscriptionplanFields[9].Descriptor()
	// subscriptionplan.DefaultCreemProductID holds the default value on creation for the creem_product_id field.
	subscriptionplan.DefaultCreemProductID = subscriptionplanDescCreemProductID.Default.(string)
	// subscriptionplan.CreemProductIDValidator is a validator for the "creem_product_id" field. It is called by the builders before save.
	subscriptionplan.CreemProductIDValidator = subscriptionplanDescCreemProductID.Validators[0].(func(string) error)
	...
	user.PublicIDValidator = func() func(string) error {
		validators := userDescPublicID.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// userDescLoginAgreementAcceptedRevision is the schema descriptor for login_agreement_accepted_revision field.
	userDescLoginAgreementAcceptedRevision := userFields[18].Descriptor()
	// user.DefaultLoginAgreementAcceptedRevision holds the default value on creation for the login_agreement_accepted_revision field.
	user.DefaultLoginAgreementAcceptedRevision = userDescLoginAgreementAcceptedRevision.Default.(string)
