...
type SubscriptionPlan struct {
	...
	// CreemProductID holds the value of the "creem_product_id" field.
...
func (*SubscriptionPlan) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case subscriptionplan.FieldName, subscriptionplan.FieldDescription, subscriptionplan.FieldValidityUnit, subscriptionplan.FieldFeatures, subscriptionplan.FieldProductName, subscriptionplan.FieldCreemProductID:
...
func (_m *SubscriptionPlan) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case subscriptionplan.FieldCreemProductID:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field creem_product_id", values[i])
			} else if value.Valid {
				_m.CreemProductID = value.String
			}
		case subscriptionplan.FieldForSale:
...
func (_m *SubscriptionPlan) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("creem_product_id=")
	builder.WriteString(_m.CreemProductID)
	builder.WriteString(", ")
