...
const DefaultCSPPolicy = "default-src 'self'; script-src 'self' __CSP_NONCE__ https://challenges.cloudflare.com https://static.cloudflareinsights.com https://*.stripe.com https://static.airwallex.com https://checkout.airwallex.com https://static-demo.airwallex.com https://checkout-demo.airwallex.com https://pagead2.googlesyndication.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://static.airwallex.com https://checkout.airwallex.com https://static-demo.airwallex.com https://checkout-demo.airwallex.com; img-src 'self' data: https:; font-src 'self' data: https://fonts.gstatic.com; connect-src 'self' https:; frame-src https://challenges.cloudflare.com https://*.stripe.com https://checkout.airwallex.com https://checkout-demo.airwallex.com https://googleads.g.doubleclick.net https://tpc.googlesyndication.com https://ep2.adtrafficquality.google https://www.google.com; frame-ancestors 'none'; base-uri 'self'; form-action 'self'"
...
func load(allowMissingJWTSecret bool) (*Config, error) {
	...
	viper.AddConfigPath("/etc/cloudbase")
...
func setDefaults() {
	...
	viper.SetDefault("log.service_name", "cloudbase")
	...
	viper.SetDefault("database.dbname", "cloudbase")
	...
	// Pricing - 默认使用工程内置模型定价和上下文窗口数据；如需远程同步，可显式配置 remote_url/hash_url。
	...
	viper.SetDefault("dashboard_cache.key_prefix", "cloudbase:")
