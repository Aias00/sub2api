...
func TestOpenAIClientTransport_GetNormalizesRawContextValue(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "type_value_ws", rawValue: OpenAIClientTransportWS, want: OpenAIClientTransportWS},
		{name: "http_sse_alias", rawValue: "http_sse", want: OpenAIClientTransportHTTP},
		{name: "sse_alias", rawValue: "sSe", want: OpenAIClientTransportHTTP},
		{name: "websocket_alias", rawValue: "WebSocket", want: OpenAIClientTransportWS},
		{name: "invalid_string", rawValue: "tcp", want: OpenAIClientTransportUnknown},
		{name: "invalid_type", rawValue: 123, want: OpenAIClientTransportUnknown},
	}
