...
const (
	dataType       = "cloudbase-data"
	legacyDataType = "cloudbase-bundle"
	dataVersion    = 1
	dataPageCap    = 1000
)
...
func validateDataAccount(item DataAccount) error {
	...
	switch item.Type {
	case service.AccountTypeOAuth, service.AccountTypeSetupToken, service.AccountTypeAPIKey, service.AccountTypeUpstream, service.AccountTypeGeminiWeb:
	default:
