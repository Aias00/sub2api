...
func (s *userHandlerRefreshTokenCacheStub) RemoveFromUserTokenSet(context.Context, int64, string) error {
	return nil
}

func (s *userHandlerRefreshTokenCacheStub) RemoveFromFamilyTokenSet(context.Context, string, string) error {
	return nil
}
