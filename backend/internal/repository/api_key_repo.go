...
func userEntityToService(u *dbent.User) *service.User {
	...
	out := &service.User{
		...
		MarketingEmailsUnsubscribedAt:  u.MarketingEmailsUnsubscribedAt,
		LoginAgreementAcceptedRevision: u.LoginAgreementAcceptedRevision,
		LoginAgreementAcceptedAt:       u.LoginAgreementAcceptedAt,
