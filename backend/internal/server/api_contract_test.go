...
import (
	...
	adminhandler "github.com/Wei-Shaw/cloudbase/internal/handler/admin"
		...
		},
		{
			...
			setup: func(t *testing.T, deps *contractDeps) {
				...
				deps.settingRepo.SetAll(map[string]string{
					...
					service.SettingKeySMTPFromName: "Cloudbase",
					...
					service.SettingKeySiteName:     "Cloudbase",
		...
		},
		{
			...
			wantJSON: `{
				...
				"data": {
					...
					"site_name": "Cloudbase",
					"site_logo": "",
					"site_subtitle": "AI Gateway and Business Operations Platform",
					"api_base_url": "",
					"api_key_acl_trust_forwarded_ip": false,
					"contact_info": "",
					"doc_url": "",
...
func (r *stubApiKeyRepo) DisableAllActiveKeysByUserID(ctx context.Context, userID int64) (int64, error) {
	return 0, nil
}
