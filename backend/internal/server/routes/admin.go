...
func registerUserManagementRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	users := admin.Group("/users")
	{
		...
		users.GET("/signup-grant-risk/claims", h.Admin.User.ListSignupGrantRiskClaims)
		users.GET("/signup-grant-risk/overrides", h.Admin.User.ListSignupGrantRiskOverrides)
		...
		users.GET("/:id/signup-grant/summary", h.Admin.User.GetSignupGrantRiskUserSummary)
		users.POST("/:id/signup-grant/manual-grant", h.Admin.User.ManualGrantSignupGiftBalance)
...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.POST("/:id/gemini-web/start", h.Admin.Account.StartGeminiWebLogin)
		accounts.GET("/:id/gemini-web/status", h.Admin.Account.GetGeminiWebLoginStatus)
		accounts.POST("/:id/gemini-web/import-cookies", h.Admin.Account.ImportGeminiWebCookies)
...
func registerAffiliateRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	affiliates := admin.Group("/affiliates")
	{
		...
		affiliates.GET("/rules", h.Admin.Affiliate.GetRules)
		affiliates.PUT("/rules", h.Admin.Affiliate.UpdateRules)
