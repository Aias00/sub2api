...
type APIKeyRateLimitCacheData = billingctx.APIKeyRateLimitCacheData
type UserPlatformQuotaKey = billingctx.UserPlatformQuotaKey
type UserPlatformQuotaCacheEntry = billingctx.UserPlatformQuotaCacheEntry

const UserPlatformQuotaCacheSchemaV1 = billingctx.UserPlatformQuotaCacheSchemaV1
