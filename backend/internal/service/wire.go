...
var ProviderSet = wire.NewSet(
	...
	wire.Bind(new(TokenRevoker), new(*AuthService)),
	wire.Bind(new(UserKeyDisabler), new(*APIKeyService)),
	NewOAuthService,
	...
	ProvideImageWorkspaceService,
	wire.Bind(new(UserBalanceReader), new(*BillingCacheService)),
	NewIdentityService,
	NewCRSSyncService,
...
func ProvideChannelMonitorRunner(svc *ChannelMonitorService, settingService *SettingService, opsService *OpsService) *ChannelMonitorRunner {
