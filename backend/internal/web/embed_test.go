...
func TestInjectSiteTitle(t *testing.T) {
	t.Run("replaces_title_with_site_name", func(t *testing.T) {
		html := []byte(`<html><head><title>Cloudbase - AI API Gateway</title></head><body></body></html>`)
		...
		assert.NotContains(t, string(result), "Cloudbase")
	})
	...
	t.Run("returns_unchanged_when_title_has_attributes", func(t *testing.T) {
		...
		html := []byte(`<html><head><title lang="en">Cloudbase</title></head><body></body></html>`)
	...
	t.Run("preserves_rest_of_html", func(t *testing.T) {
		html := []byte(`<html><head><meta charset="UTF-8"><title>Cloudbase</title><script src="app.js"></script></head><body><div id="app"></div></body></html>`)
	...
	t.Run("escapes_ampersand_in_site_name", func(t *testing.T) {
		html := []byte(`<html><head><title>Cloudbase</title></head><body></body></html>`)
