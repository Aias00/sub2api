...
### 目标
本文档用于对接外部支付或计费系统与 Cloudbase 的 Admin API，覆盖：
- 支付成功后充值
- 用户查询
- 人工余额修正
- 前端购买页参数透传
...
```json
{
  ...
  "value": 100.0,
  "user_id": 123,
  "notes": "external billing order: cm1234567890"
}
```
...
### 6) `doc_url` 配置建议
- 查看链接：`https://github.com/Aias00/cloudbase/blob/main/docs/ADMIN_PAYMENT_INTEGRATION_API.md`
- 下载链接：`https://raw.githubusercontent.com/Aias00/cloudbase/main/docs/ADMIN_PAYMENT_INTEGRATION_API.md`
...
### Purpose
This document describes the minimal Cloudbase Admin API surface for external payment or billing integrations, including:
...
- View URL: `https://github.com/Aias00/cloudbase/blob/main/docs/ADMIN_PAYMENT_INTEGRATION_API.md`
- Download URL: `https://raw.githubusercontent.com/Aias00/cloudbase/main/docs/ADMIN_PAYMENT_INTEGRATION_API.md`
