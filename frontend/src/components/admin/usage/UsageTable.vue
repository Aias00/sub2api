      ...
      >
        ...
        <template #cell-endpoint="{ row }">
          <div class="max-w-[320px] space-y-1 text-xs">
            ...
            <div class="break-all text-gray-700 dark:text-gray-300">
              <span class="font-medium text-gray-500 dark:text-gray-400">{{ t('common.usageRouting.upstream') }}:</span>
        ...
        <div class="space-y-1.5">
          <div>
            ...
            <div v-if="tokenTooltipData && tokenTooltipData.output_tokens > 0" class="flex items-center justify-between gap-4">
              <span class="text-gray-400">{{ t('common.usageMetrics.outputTokens') }}</span>
          ...
          <div class="mb-2 border-b border-gray-700 pb-1.5">
            ...
            <template v-else-if="!tooltipData?.billing_mode || tooltipData.billing_mode === BILLING_MODE_TOKEN">
              ...
              <div v-if="tooltipData && tooltipData.output_tokens > 0" class="flex items-center justify-between gap-4">
                ...
                <span class="font-medium text-violet-300">{{ formatTokenPricePerMillion(tooltipData.output_cost, tooltipData.output_tokens) }} {{ t('common.usageMetrics.perMillionTokens') }}</span>
              </div>
            </template>
            <div v-else class="flex items-center justify-between gap-4">
