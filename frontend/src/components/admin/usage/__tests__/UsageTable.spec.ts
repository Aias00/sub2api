...
const messages: Record<string, string> = {
  ...
  'admin.usage.rate': 'Rate',
  'common.billingMetrics.accountMultiplier': 'Account rate',
  'admin.usage.original': 'Original',
  'common.billingMetrics.userBilled': 'User billed',
  'common.billingMetrics.accountBilled': 'Account billed',
