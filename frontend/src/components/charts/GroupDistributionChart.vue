...
const displayGroupStats = computed(() => {
  ...
  return [...props.groupStats].sort((a, b) => toNumber(b[metricKey]) - toNumber(a[metricKey]))
})
...
const chartData = computed(() => {
  ...
  return {
    ...
    datasets: [
      {
        data: displayGroupStats.value.map((g) => props.metric === 'actual_cost' ? toNumber(g.actual_cost) : toNumber(g.total_tokens)),
