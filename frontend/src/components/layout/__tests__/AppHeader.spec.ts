...
describe('AppHeader GitHub dropdown visibility', () => {
  ...
  it('keeps the embedded frontend dist aligned with the admin-only rule', () => {
    ...
    expect(appLayoutSource).toContain('href:"https://github.com/Aias00/cloudbase"')
    expect(appLayoutSource).not.toContain('}),e("a",{href:"https://github.com/Aias00/cloudbase"')
  })
})
