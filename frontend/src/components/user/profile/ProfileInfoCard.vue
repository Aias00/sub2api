<template>
  <div class="space-y-6">
    <section
      ...
      class="card overflow-hidden border border-sky-100/80 bg-gradient-to-br from-sky-50 via-white to-blue-50/70 dark:border-sky-900/40 dark:from-sky-950/40 dark:via-dark-900 dark:to-dark-950"
    >
