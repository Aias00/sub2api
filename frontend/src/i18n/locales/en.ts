export default {
  ...
  nav: {
    ...
    affiliateOverview: 'Affiliate Overview',
    affiliateRules: 'Affiliate Rules',
    affiliateCodeManagement: 'Affiliate Codes',
  ...
  auth: {
    ...
    loginAgreementRejectedLogin: 'Please accept the latest terms before logging in.',
    loginAgreementRejectedRegister: 'Please accept the latest terms before registering.',
    loginAgreementMustAcceptRegister: 'Please read and accept the latest terms before registering.',
  ...
  admin: {
    accounts: {
      ...
      upstream: {
        ...
        presetLabel: 'Quick vendor',
        presetPlaceholder: 'Pick a vendor to auto-fill Base URL and models (optional)',
      },
    ...
    users: {
      ...
      profileSummary: {
        ...
        riskTags: 'Classification Tags',
        noRiskTags: 'No risk or helper tags',
        registration: 'Registration',
        identity: 'Identity & Activity',
        apiAndBilling: 'API & Billing',
        ...
        headerSnapshot: 'Registration Header Snapshot',
        nearbyEvent: 'Nearby Auth Event',
        sameIp24h: 'Same IP 24h Signups',
        sameDomain: 'Same Domain Users',
        createdAt: 'Created',
        lastLogin: 'Last Login',
        lastActive: 'Last Active',
        lastUsed: 'Last Used',
        noAuthIdentities: 'No auth identity records',
        activeApiKeys: 'Active / Total Keys',
        firstApiKey: 'First Key',
        lastApiKey: 'Latest Key',
        usageWindow: 'Usage Window',
        ledger: 'Ledger Net',
        redeem: 'Redeem Records',
        imageTasks: 'Image Success / Total',
        imageCost: 'Image Cost',
        imageWindow: 'Image Window',
        wechatTasks: 'WeChat Export Tasks',
        wechatCost: 'WeChat Export Cost',
        wechatWindow: 'WeChat Export Window',
        timeline: 'Operation Timeline',
        timelineCount: '{count} records',
        noTimeline: 'No operation records',
        timelineSources: {
          registration: 'Registration',
          identity: 'Identity',
          api_key: 'API Key',
        ...
        loadFailed: 'Failed to load user profile summary',
      },
    ...
    userInsights: {
      title: 'User Insights',
      description: 'Aggregate signup sources, activation funnel, registration context, and users needing review.',
      classification: 'User Classification',
      signupSources: 'Signup Sources',
      funnel: 'Behavior Funnel',
      topIPs: 'Top Registration IPs',
      topUserAgents: 'Top User-Agents',
      topLanguages: 'Top Languages',
      riskSamples: 'Review Samples',
      user: 'User',
      label: 'Label',
      registrationIp: 'Registration IP',
      createdAt: 'Created',
      noRiskSamples: 'No review samples',
      loadFailed: 'Failed to load user insights',
    },
    groups: {
    ...
    settings: {
      ...
      registration: {
        ...
        passwordMinLengthHint: 'Minimum number of characters required for newly registered user passwords.',
      ...
      gatewayForwarding: {
        ...
        openaiAllowClaudeCodeCodexPluginDesc: 'Allow Claude Code requests that access OpenAI through the Codex plugin while keeping Codex client restrictions enabled.',
      ...
      payment: {
        ...
        rechargeProductsSection: {
          amount: 'Amount',
          description: 'Configure one product to show one option; when empty, users will see no available recharge products.',
          empty: 'No recharge products are configured. Users will see no available recharge products.',
    ...
    ops: {
      ...
      systemLogs: {
        heading: 'System Logs',
        subheading: 'Newest logs are shown first. Filter, search, and clean up by condition.',
        title: 'System Logs',
        ...
        runtimeResetDefaults: 'Reset defaults',
        saveAndApply: 'Save and apply',
        resetDefaults: 'Reset defaults',
        latestWriteError: 'Latest write error:',
        recentWriteError: 'Latest write error: {error}',
        timeRange: 'Time range',
        ...
        cleanupByFilter: 'Clean current filters',
        refreshReset: 'Reset',
        ...
        runtimeConfigResetConfirm: 'Reset to startup configuration (env/yaml) and apply immediately?',
        runtimeConfigReset: 'Reset to startup log configuration',
        runtimeConfigResetSuccess: 'Reset to startup log configuration',
      ...
      runtime: {
        ...
        metricThresholdsHint: 'Configure runtime alert thresholds for highlighted health metrics.',
        slaMinPercent: 'Minimum SLA (%)',
        slaMinPercentHint: 'Treat SLA below this value as abnormal.',
        ttftP99MaxMs: 'TTFT P99 max (ms)',
        ttftP99MaxMsHint: 'Treat first-token P99 above this value as abnormal.',
        requestErrorRateMaxPercent: 'Request error rate max (%)',
        requestErrorRateMaxPercentHint: 'Treat request error rate above this value as abnormal.',
        upstreamErrorRateMaxPercent: 'Upstream error rate max (%)',
        upstreamErrorRateMaxPercentHint: 'Treat upstream error rate above this value as abnormal.',
