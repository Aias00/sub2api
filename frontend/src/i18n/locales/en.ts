export default {
  admin: {
    ...
    riskControl: {
      ...
      preBlockAPIKeyLoadHint: 'Synchronous pre-block moderation polls available moderation keys directly.',
      ...
      workerStatusHint: 'Queue and worker pool status for pre-block record tasks.'
    },
    scheduledTests: {
      addPlan: 'Add Plan',
