  ...
  admin: {
    accounts: {
      ...
      status: {
        active: '正常',
        cooldown: '冷却中',
        creditsExhausted: '余额已用尽',
        creditsExhaustedUntil: 'AI Balance 已用尽，预计 {time} 恢复',
        error: '错误',
        inactive: '停用',
        limited: '限流',
        modelCreditOveragesUntil: '{model} 正在使用 AI Balance，至 {time}',
    ...
    riskControl: {
      ...
      workerStatusHint: '前置拦截记录任务的队列和 worker 池状态。'
    },
    scheduledTests: {
      addPlan: '添加计划',
      autoRecover: '自动恢复',
