/**
 * Core Type Definitions for Cloudbase Frontend
 */
...
export interface AdminUser extends User {
  ...
  registration_accept_language?: string
...
export type AccountType = 'oauth' | 'setup-token' | 'apikey' | 'upstream' | 'bedrock' | 'service_account' | 'gemini-web'
...
export interface GeminiWebSessionResponse {
  account_id?: number
  login_id: string
  status: 'idle' | 'waiting_import' | 'pending' | 'ready' | 'error' | string
  message?: string
  updated_at?: string
  action?: string
  login_url?: string
  expires_at?: string | null
  login_mode?: 'auto' | 'remote' | 'local' | string
  has_cookies?: boolean
