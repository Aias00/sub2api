...
async function loadProviderName() {
  try {
    ...
    // Ignore; provider display name remains empty until settings provide one.
  }
}
...
function extractPendingAccountEmail(completion: PendingOidcCompletion): string {
  return extractSharedPendingAccountEmail(completion)
}
...
async function handleSubmitInvitation() {
  ...
  try {
    ...
    const completion: PendingOidcCompletion = affCode
