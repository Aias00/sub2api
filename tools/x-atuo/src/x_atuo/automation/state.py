...
class WorkflowContractKind(str, Enum):
    FEED_ENGAGE = "feed-engage"
    AUTHOR_ALPHA_ENGAGE = "author-alpha-engage"
    AUTHOR_ALPHA_SYNC = "author-alpha-sync"


def workflow_contract_kind_for(workflow: WorkflowKind) -> WorkflowContractKind:
    if workflow is WorkflowKind.FEED_ENGAGE:
        return WorkflowContractKind.FEED_ENGAGE
    if workflow is WorkflowKind.AUTHOR_ALPHA_ENGAGE:
        return WorkflowContractKind.AUTHOR_ALPHA_ENGAGE
    return WorkflowContractKind.AUTHOR_ALPHA_SYNC
